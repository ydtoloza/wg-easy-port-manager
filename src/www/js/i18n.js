...
const messages = { // eslint-disable-line no-unused-vars
  en: {
    ...
    notifications: {
      ...
      probes: 'Probe status',
      probeEmpty: 'No probe results yet. Expand a peer to probe its rules.',
    },
    pf: {
      randomPort: 'Random free port (seeding)',
      randomPortNone: 'No free port available in the configured range.',
    },
    allPorts: {
      title: 'All ports',
      search: 'Search peer or port…',
      allProtos: 'All protocols',
      allStatus: 'All statuses',
      statusOk: 'Reachable',
      statusProblems: 'Problems',
      statusUnknown: 'Not probed',
      empty: 'No forwarding rules match the current filters.',
      jump: 'Open this peer’s port forwarding',
    },
    restore: 'Restore',
    backup: 'Backup',
    ...
    networkPolicy: {
      ...
      blockedOutbound: 'Blocked outbound protocols',
      blockedOutboundHelp: 'Block traffic from this client to the VPN server, peers, and the internet.',
      portNotice: 'Protocol detection uses standard TCP/UDP ports. Alternate ports and encrypted tunnels cannot be identified.',
      peerAccess: 'Allowed peers',
      peerAccessHelp: 'Clients are isolated by default. Select the peers that may communicate with this client in both directions.',
      noPeers: 'No other clients are available.',
      customRules: 'Custom blocked ports',
      customRulesHelp: 'Add a TCP or UDP port, or a port range.',
      ruleLabel: 'Optional label',
      startPort: 'Start port',
      endPort: 'End port',
      addRule: 'Add rule',
      noCustomRules: 'No custom blocked ports.',
      invalidPortRange: 'Enter a valid port or range between 1 and 65535.',
      ruleLimit: 'A maximum of {count} custom rules is allowed.',
      save: 'Apply policy',
      saving: 'Applying...',
      ...
      verdictTitle: 'Probe: {verdict}',
      verdict: {
        ok: 'Reachable',
        unreachable: 'Unreachable',
        'rule-missing': 'Rule missing',
        'dnat-local': 'Open on server',
        'tunnel-down': 'Peer offline',
        indeterminate: 'UDP (not verifiable)',
      },
    },
  },
  ua: {
  ...
  es: { // github.com/amarqz
    ...
    traffic: {
      ...
      peak: 'Pico',
      total: 'Total',
      hide: 'Ocultar tráfico',
      show: 'Mostrar tráfico',
      noData: 'Esperando muestras…',
    },
    ...
    notifications: {
      ...
      probes: 'Estado de las sondas',
      probeEmpty: 'Sin resultados aún. Expande un peer para sondear sus reglas.',
    },
    pf: {
      randomPort: 'Puerto libre aleatorio (seeding)',
      randomPortNone: 'No hay puertos libres en el rango configurado.',
    },
    allPorts: {
      title: 'Todos los puertos',
      search: 'Buscar peer o puerto…',
      allProtos: 'Todos los protocolos',
      allStatus: 'Todos los estados',
      statusOk: 'Alcanzables',
      statusProblems: 'Con problemas',
      statusUnknown: 'Sin sonda',
      empty: 'Ninguna regla coincide con los filtros actuales.',
      jump: 'Abrir el reenvío de puertos de este peer',
    },
    restore: 'Restaurar',
    ...
    networkPolicy: {
      title: 'Política de red',
      blockedOutbound: 'Protocolos salientes bloqueados',
      blockedOutboundHelp: 'Bloquea el tráfico de este cliente hacia el servidor VPN, otros peers e Internet.',
      portNotice: 'La detección usa puertos TCP/UDP estándar. No se pueden identificar puertos alternativos ni túneles cifrados.',
      peerAccess: 'Peers permitidos',
      peerAccessHelp: 'Los clientes están aislados por defecto. Selecciona los peers que podrán comunicarse con este cliente en ambos sentidos.',
      noPeers: 'No hay otros clientes disponibles.',
      customRules: 'Puertos personalizados bloqueados',
      customRulesHelp: 'Añade un puerto TCP o UDP, o un rango de puertos.',
      ruleLabel: 'Etiqueta opcional',
      startPort: 'Puerto inicial',
      endPort: 'Puerto final',
      addRule: 'Añadir regla',
      noCustomRules: 'No hay puertos personalizados bloqueados.',
      invalidPortRange: 'Introduce un puerto o rango válido entre 1 y 65535.',
      ruleLimit: 'Se permite un máximo de {count} reglas personalizadas.',
      ...
      probeNever: 'Aún sin sondear',
      verdictTitle: 'Sonda: {verdict}',
      verdict: {
        ok: 'Alcanzable',
        unreachable: 'Inalcanzable',
        'rule-missing': 'Regla ausente',
        'dnat-local': 'Abierto en el servidor',
        'tunnel-down': 'Peer desconectado',
        indeterminate: 'UDP (no verificable)',
      },
    },
  },
  ko: {
